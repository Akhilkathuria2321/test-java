...
public class Example {
 ...
 public static void main(final String[] args) {
     ...
     Example.bcImpossibleCastCORRECT();
     ...
     try {
         ...
         Example.bcImpossibleDowncastWRONG();
     ...
     Example.bcImpossibleDowncastCORRECT();
     ...
     Example.bcImpossibleInstanceOfWRONG();

     // CORRECT

     Example.bcImpossibleInstanceOfCORRECT();
     ...
     try {
         ...
         Example.bcImpossibleDowncastOfArrayWRONG();
     ...
     Example.bcImpossibleDowncastOfArrayCORRECT();
     ...
     Example.dmiBigDecimalConstructedFromDoubleWRONG();

     // CORRECT

     Example.dmiBigDecimalConstructedFromDoubleCORRECT();
     ...
     Example.esComparingStringsWithEqWRONG();

     // CORRECT

     Example.esComparingStringsWithEqCORRECT();
     ...
     try {
         ...
         Example.vaFormatStringIllegalWRONG();
     ...
     Example.vaFormatStringIllegalCORRECT();
     ...
     Example.rvReturnValueIgnoredWRONG();

     // CORRECT

     Example.rvReturnValueIgnoredCORRECT();
     ...
     Example.qabQuestionableBooleanAssignmentWRONG();

     // CORRECT

     Example.qabQuestionableBooleanAssignmentCORRECT();
